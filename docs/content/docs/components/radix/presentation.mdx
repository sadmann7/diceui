...
new: true
links:
  doc: https://pptx.diceui.com/docs
  api: /docs/components/radix/presentation#api-reference
---

<ComponentTabs name="presentation-demo" className="h-100 p-0" />
...
<ComponentTabs name="presentation-editing-demo" className="h-100 p-0" />

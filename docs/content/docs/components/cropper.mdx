...
A cropper integrated with form validation for profile picture uploads.

<ComponentTabs name="cropper-form-demo" />
...
The interactive content area where cropping happens.
...
The cropper automatically provides appropriate ARIA labels and roles:

- The content area has `role="img"` and appropriate `aria-label`
- Keyboard navigation is announced to screen readers

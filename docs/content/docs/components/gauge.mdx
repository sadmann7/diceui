...
A full 360° circular gauge, perfect for showing percentage-based metrics like CPU usage or completion rates.

<ComponentTabs name="gauge-circle-demo" />

### Controlled

A gauge with interactive controls to adjust the value dynamically.

<ComponentTabs name="gauge-controlled-demo" />

...
<KeyboardShortcutsTable
  data={[
    {
      keys: ["Escape"],
      description: "Closes the dialog/drawer.",
    },
    {
      keys: ["Tab"],
      description: "Moves focus to the next focusable element within the dialog/drawer.",
    },
    {
      keys: ["Shift + Tab"],
      description: "Moves focus to the previous focusable element within the dialog/drawer.",
    },
  ]}
/>

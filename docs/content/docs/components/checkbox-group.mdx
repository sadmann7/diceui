...
<AutoTypeTable
  path="./types/docs/checkbox-group.ts"
  name="CheckboxGroupIndicatorProps"
/>
...
<AutoTypeTable
  path="./types/docs/checkbox-group.ts"
  name="CheckboxGroupDescriptionProps"
/>
...
<AutoTypeTable
  path="./types/docs/checkbox-group.ts"
  name="CheckboxGroupMessageProps"
/>

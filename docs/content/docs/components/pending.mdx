---
title: Pending
description: A utility component and hook for managing pending states on interactive elements with proper accessibility and user feedback.
preview: true
links:
  api: /docs/components/pending#api-reference
---

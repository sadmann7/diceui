...
<ComponentTabs name="editable-demo" scalePreview />
...
A basic editable text field with submit and cancel buttons.

<ComponentTabs name="editable-basic-demo" />

### With Double Click

Trigger edit mode with double click instead of single click.

<ComponentTabs name="editable-double-click-demo" />

### With Autosize

Input that automatically resizes based on content.

<ComponentTabs name="editable-autosize-demo" />

### Read Only

Display editable content in read-only mode.

<ComponentTabs name="editable-readonly-demo" />

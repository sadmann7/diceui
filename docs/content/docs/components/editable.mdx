...
<ComponentTabs name="editable-demo" className="[&>div]:h-full justify-start" />
...
<ComponentTabs name="editable-double-click-demo" className="[&>div]:h-full justify-start" />

### With Autosize

Input that automatically resizes based on content.

<ComponentTabs name="editable-autosize-demo" className="[&>div]:h-full justify-start" />

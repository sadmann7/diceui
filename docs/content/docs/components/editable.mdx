...
<ComponentTabs name="editable-demo" className="items-start justify-start pt-40" />
...
<ComponentTabs name="editable-double-click-demo" className="items-start justify-start pt-40" />

### With Autosize

Input that automatically resizes based on content.

<ComponentTabs name="editable-autosize-demo" className="items-start justify-start pt-40" />

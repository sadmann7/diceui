...
This example demonstrates using the [Mux Player React](https://github.com/muxinc/elements/tree/main/packages/mux-player-react) package as the video element to enable HLS playback.

<ComponentTabs name="media-player-hsl-demo" className="block" />

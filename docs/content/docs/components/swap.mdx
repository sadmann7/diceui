...
The swap component supports 8 different animation types: fade, rotate, flip, scale, slide-up, slide-down, slide-left, and slide-right.
...
<DataAttributesTable
  data={[
    ...
    },
    {
      ...
      value: ["fade", "rotate", "flip", "scale", "slide-up", "slide-down", "slide-left", "slide-right"],
    },
    {
      title: "[data-disabled]",

...
<Steps>
  ...
  <Step>
    Copy and paste the refs composition utilities into your `components/composition.tsx` file.

    <ComponentSource name="composition" />
  </Step>
  <Step>
    Copy and paste the direction provider into your `components/direction.tsx` file.

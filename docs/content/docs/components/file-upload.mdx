...
<ComponentTabs name="file-upload-demo" align="start" />
...
<ComponentTabs name="file-upload-validation-demo" align="start" />

### With Auto Upload

Automatically start uploading files when they are added with the `onUpload` prop on the `Root` component.

<ComponentTabs name="file-upload-auto-upload-demo" align="start" />
...
<ComponentTabs name="file-upload-form-demo" align="start" />

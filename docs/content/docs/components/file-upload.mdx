...
<ComponentTabs name="file-upload-demo" fullPreview />
...
A basic file upload component with drag and drop functionality.
...
<ComponentTabs name="file-upload-auto-upload-demo" fullPreview />

### With Validation

Validate files based on type, size, and custom rules.

<ComponentTabs name="file-upload-validation-demo" fullPreview />

### Multiple File Upload

Upload multiple files at once.

<ComponentTabs name="file-upload-multiple-demo" fullPreview />

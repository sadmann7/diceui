...
Automatically start uploading files when they are added with the `onUpload` prop on the `Root` component.
...
<ComponentTabs name="file-upload-circular-progress-demo" align="start" className="p-4" />

### With Form

Use the `FileUpload` component inside a `Form` component to handle file uploads with validation and submission.

<ComponentTabs name="file-upload-form-demo" align="start" className="p-4" />

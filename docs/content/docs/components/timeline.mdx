...
### Timeline with Variants

Use different visual variants to visualize event states across the entire timeline.
...
The timeline supports multiple visual variants (`default`, `primary`, `success`, `warning`, `destructive`) applied at the root level. The variant affects the color scheme of all dots and connectors in the timeline, making it easy to visualize different states or categories.

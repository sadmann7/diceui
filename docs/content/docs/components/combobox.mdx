...
<AutoTypeTable
  path="./types/docs/combobox.ts"
  name="ComboboxBadgeItemDeleteProps"
/>
...
<AutoTypeTable
  path="./types/docs/combobox.ts"
  name="ComboboxItemIndicatorProps"
/>

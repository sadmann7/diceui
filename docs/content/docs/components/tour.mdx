...
- [Radix UI Dismissable Layer](https://www.radix-ui.com/primitives/docs/utilities/dismissable-layer) - For the pointer down outside and interact outside event handling patterns.
- [Radix UI Focus Guard](https://www.radix-ui.com/primitives/docs/utilities/focus-guards) - For the focus guard implementation.

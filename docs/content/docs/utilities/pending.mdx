---
title: Pending
description: Prevent duplicate actions during async operations. Disables interactions, maintains keyboard focus, and ensures proper accessibility for buttons, forms, links, switches, and any interactive element.
preview: true
links:

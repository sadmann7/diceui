...
- **Credits**: Implementation inspired by [React Aria's Button](https://github.com/adobe/react-spectrum/blob/main/packages/react-aria-components/src/Button.tsx) (Apache License 2.0)

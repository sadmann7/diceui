      ...
      <Sortable.Content className="grid grid-cols-3 gap-2.5">
        {tricks.map((trick) => (
          <Sortable.Item key={trick} value={trick} asChild asHandle>
            <div className="flex size-full flex-col items-center justify-center border border-zinc-200 bg-zinc-100 p-6 text-center shadow-xs dark:border-zinc-800 dark:bg-zinc-900">

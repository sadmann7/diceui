...
export default function AvatarGroupCustomOverflowDemo() {
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-3">
        ...
        <AvatarGroup
          ...
          renderOverflow={(count) => (
            <div className="flex size-full items-center justify-center rounded-full border-2 border-dashed border-primary bg-primary/10 font-semibold text-primary text-xs">
              {count}+
            </div>
          )}
        >
      ...
      <div className="flex flex-col gap-3">
        <h3 className="font-medium text-sm">Custom Overflow with Text</h3>
        <AvatarGroup
          max={3}
          renderOverflow={(count) => (
            <div className="flex size-full items-center justify-center rounded-full bg-gradient-to-br from-purple-500 to-pink-500 font-bold text-white text-xs">
              +{count}
            </div>
          )}
        >

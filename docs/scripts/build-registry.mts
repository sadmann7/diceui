...
// ----------------------------------------------------------------------------
// Build __registry__/index.tsx and __registry__/examples/index.tsx.
// ----------------------------------------------------------------------------
          ...
          chunks = await Promise.all(
            ...
            export default function Component() {
              ...
              return {
                ...
                component: `React.lazy(async () => { const mod = await import("@/registry/bases/${baseName}/${type}/${chunkName}"); return { default: mod.default || mod["${chunkName}"] } }),`,
                file: targetFile,
                container: {
      ...
      "${item.name}": {
        ...
        files: [${item.files?.map((file) => {
          ...
          shouldGenerateComponent
            ? `
        component: React.lazy(async () => { const mod = await import("${componentPath}"); return { default: mod.default || mod["${item.name}"] } }),`
            : ""
        }

...
export interface KanbanBoardProps extends EmptyProps<"div">, RenderProps {
  /** The children of the kanban board. */
  children: React.ReactNode;
}

export interface KanbanColumnProps extends EmptyProps<"div">, RenderProps {
  /**
...
export interface KanbanItemProps extends EmptyProps<"div">, RenderProps {
  /**

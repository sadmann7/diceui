...
export interface SortableContentProps extends EmptyProps<"div">, RenderProps {
  /**
   * The strategy to use for sorting the items.
   *
   * @default
  ...
  /**
   * Whether to render the children without a wrapper element.
   *
   * When `true`, the `render` prop is ignored.
   *
   * @default false
   */
  withoutSlot?: boolean;
...
export interface SortableItemProps extends EmptyProps<"div">, RenderProps {
  /**
...
export interface SortableItemHandleProps
  extends EmptyProps<"button">, RenderProps {}
